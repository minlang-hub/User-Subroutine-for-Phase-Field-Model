...
!               y1 y2 y3 y4      
      ...
      real(8):: props(5), coords(2,4), u(12), svars(4)
!     local varibles
...
!     initialize varibles
     ...
     &                            guassp(j),coords)    
              ...
              !几何函数alpha_d的一阶导dalpha以及二阶导ddalpha(c0为pi）
              call alpha_dd(dalpha,pf,ddalpha)
              !退化函数omega、一阶导数domega、二阶导数ddomega
...
!================traditional material propoty matrix================================
      ...
      implicit none
      real(8):: d(3,3), props(5)
      real(8):: e, mu, a1, a2
      !real(8):: a3 !!!plane strain
      d=0.d0
...
!!!!plane stress
      ...
      d=a1*d     
!!!!plane strain
      !a1=e*(1.d0-mu)/(1.d0+mu)/(1.d0-2.d0*mu)
      !a2=mu/(1.d0-mu)
      !a3=(1.d0-2.d0*mu)/2.d0/(1.d0-mu)
      !d(1,1)=1.d0;    d(1,2)=a2
      !d(2,1)=a2;      d(2,2)=1.d0
      !                                 d(3,3)=a3
      !d=a1*d     
...
!==================energy_plus==================================================
      ...
      implicit none
      real(8):: energy_plus, b(3,8), uu(8,1), props(5)
      real(8):: epsi(3,1)   
      real(8):: E, mu, lamd, G
