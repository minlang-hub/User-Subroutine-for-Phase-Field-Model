...
C     time indices
     ...
     &          adlmag(nblock)
      ...
      real(8):: coordinate(2,4), copy_props(9)
      real(8):: sub_u(8,1)
      real(8):: sub_d(4,1)
      real(8):: val_svars(1)
...
!====================== subroutines ==============================================================
      ...
      ro=props(8); thickness=props(3); v_eta=props(7)
     ...
     & val_svars)
      ...
      !            1  2     3      4  5  6   7    8   9
      implicit none
      real(8):: dis_rhs(8,1),dd_rhs(4,1),props(9),coords(2,4),u(8,1)
      real(8):: sub_d(4,1)
      real(8):: val_svars(1)
      ...
      thickness=props(3)
      Gf=props(4); lb=props(6); v_eta=props(7)
...
!===============degradation function and its derivations========================
      ...
      !            1  2     3      4  5  6   7    8   9
      implicit none
      real(8):: omega, domega, ddomega, pf, props(9), c0
!     local varibles
      real(8):: g, dg, ddg, fai, dfai, ddfai, E, Gf, ft, lb
!     cohesive related parameters
      real(8):: p, a1, a2, a3
...
!==================energy_plus==================================================
     ...
     &                                                 b,uu,props)
      ...
      implicit none
      real(8):: stress_plus(3,1), stress_minus(3,1)
      real(8):: energy_plus, b(3,8), uu(8,1), props(9)
